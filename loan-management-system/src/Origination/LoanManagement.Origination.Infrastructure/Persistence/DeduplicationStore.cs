...
/// <summary>EF Core-backed deduplication store for idempotent status-projection consumers.</summary>
public sealed class DeduplicationStore(OriginationDbContext db) : IDeduplicationStore
{
